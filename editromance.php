<html>
<head>
<title>Edit Romance Movie</title>
<style>
body {
  margin: 0;
...
<h1 style="color:black; font-size:50;">Edit Romance Movie</h1>
<form align="center" name="frm_register" id="frm_register" method="POST" action="editromance.php">
...
<?php
	...
	//$sql="select email_address, address, home_phone, mobile_phone from tbl_user_details WHERE email_address = $v_email";
		...
		$sql = "SELECT * FROM tbl_romance_movies WHERE movie_id LIKE '%$q%'";
...
<form align="center" name="frm_register" id="frm_register" method="POST" action="ceditromance.php">
Movie ID  :
