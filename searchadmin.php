...
<?php
	...
	echo "</tr>";
		...
		echo "<td><a href='romance_home_admin.php'>" . $row['category'] . "</a></td>";
	...
	echo "</tr>";
		...
		echo "<td>" . $row["year_of_release"]. "</td>";
		echo "<td>" . $row["price"]. "</td>";
		echo "<td><a href='comedy_home_admin.php'>" . $row['category'] . "</a></td>";
	...
	echo "</tr>";
		...
		echo "<td>" . $row["year_of_release"]. "</td>";
		echo "<td>" . $row["price"]. "</td>";
		echo "<td><a href='action_home_admin.php'>" . $row['category'] . "</a></td>";
