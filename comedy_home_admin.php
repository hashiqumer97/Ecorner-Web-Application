	...
	if($_GET["action"] == "delete")
	{
		foreach($_SESSION["shopping_cart"] as $keys => $values)
		{
			if($values["movie_id"] == $_GET["id"])
			{
				...
				echo '<script>window.location="comedy_home_admin.php"</script>';
			}
		}
	}
}
...
.topnav a.active {
  ...
  <a href="plogout.php">Log Out</a>
		...
		<div class="container">
			...
			<h1 style="color:brown; font-size:50;">Select Movie - <a title="Comedy Movies">Comedy Movies</a></h1><br />
			<br /><br />
			<?php
				$query = "SELECT * FROM tbl_comedy_movies ORDER BY movie_id ASC";
				...
				?>
			<div class="col-md-4">
				<form method="post" action="comedy_home_admin.php?action=add&id=<?php echo $row["movie_id"]; ?>">
			...
			<div class="table-responsive">
				<table class="table table-bordered">
					...
					<tr>
						...
						<td><a href="comedy_home_admin.php?action=delete&id=<?php echo $values["movie_id"]; ?>"><span class="text-danger">Remove</span></a></td>
					</tr>
					<?php
					...
					<tr>
						...
						<td><button type="submit"  href="pcomedy_home.php">Pay</button></td>
					</tr>
					<?php
					}
					?>
