	...
	if($_GET["action"] == "delete")
	{
		foreach($_SESSION["shopping_cart"] as $keys => $values)
		{
			if($values["movie_id"] == $_GET["id"])
			{
				...
				echo '<script>window.location="action_home.php"</script>';
			}
		}
	}
}
  ...
  <a href="plogout.php">Log Out</a>
		...
		<div class="container">
			...
			<?php
				...
				?>
			<div class="col-md-4">
				<form method="post" action="action_home.php?action=add&id=<?php echo $row["movie_id"]; ?>">
			...
			<div class="table-responsive">
				<table class="table table-bordered">
					...
					<tr>
						...
						<td><a href="action_home.php?action=delete&id=<?php echo $values["movie_id"]; ?>"><span class="text-danger">Remove</span></a></td>
					</tr>
					<?php
