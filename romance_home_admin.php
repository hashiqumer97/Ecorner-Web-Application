	...
	if($_GET["action"] == "delete")
	{
		foreach($_SESSION["shopping_cart"] as $keys => $values)
		{
			if($values["movie_id"] == $_GET["id"])
			{
				...
				echo '<script>window.location="romance_home_admin.php"</script>';
			}
		}
	}
}
...
.topnav a.active {
  ...
  <a href="plogout.php">Log Out</a>
		...
		<div class="container">
			...
			<h1 style="color:brown; font-size:50;">Select Movie - <a title="Romance Movies">Romance Movies</a></h1><br />
			<br /><br />
			<?php
				$query = "SELECT * FROM tbl_romance_movies ORDER BY movie_id ASC";
				...
				?>
			<div class="col-md-4">
				<form method="post" action="romance_home_admin.php?action=add&id=<?php echo $row["movie_id"]; ?>">
			...
			<div class="table-responsive">
				<table class="table table-bordered">
					...
					<tr>
						...
						<td><a href="romance_home_admin.php?action=delete&id=<?php echo $values["movie_id"]; ?>"><span class="text-danger">Remove</span></a></td>
					</tr>
					<?php
					...
					?>
					<tr>
						<form align="center" name="frm_register" id="frm_register" method="POST" action="paypageadmin.php">
						<td colspan="3" align="right">Total</td>
						<td align="right">LKR. <?php echo number_format($total, 2); ?></td>
						<td><button type="submit"  href="promance_home.php">Pay</button></td>
					</tr>
					<?php
					}
					?>
