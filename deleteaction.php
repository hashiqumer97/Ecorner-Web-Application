<html>
<head>
<title>Delete Action Movie</title>
<style>
body {
  margin: 0;
...
<h1 style="color:black; font-size:50;">Delete Action Movie</h1>
<form align="center" name="frm_register" id="frm_register" method="POST" action="cdeleteaction.php">
