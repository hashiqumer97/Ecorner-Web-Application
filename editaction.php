...
<h1 style="color:black; font-size:50;">Edit Action Movie</h1>
<form align="center" name="frm_register" id="frm_register" method="POST" action="editaction.php">
...
<?php
	...
	//$sql="select email_address, address, home_phone, mobile_phone from tbl_user_details WHERE email_address = $v_email";
		...
		$sql = "SELECT * FROM tbl_action_movies WHERE movie_id LIKE '%$q%'";
...
<form align="center" name="frm_register" id="frm_register" method="POST" action="ceditaction.php">
Movie ID  :
