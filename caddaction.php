...
*/	
	...
	$sqlaction="insert into tbl_action_movies (movie_name, name_of_director, name_of_music_director, name_of_producer, cast, year_of_release, price, picture, category) values 
...
else
{
	...
	echo '<script>window.location.href = "addaction.php";</script>';
