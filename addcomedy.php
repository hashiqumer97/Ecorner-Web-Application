...
<h1 style="color:black; font-size:50;">Add Comedy Movie</h1>
<form align="center" name="frm_register" id="frm_register" method="POST" action="caddcomedy.php">
