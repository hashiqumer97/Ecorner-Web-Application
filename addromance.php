...
<h1 style="color:black; font-size:50;">Add Romance Movie</h1>
<form align="center" name="frm_register" id="frm_register" method="POST" action="caddromance.php">
...
<button type="submit"  href="addmovie.php">Insert</button>
